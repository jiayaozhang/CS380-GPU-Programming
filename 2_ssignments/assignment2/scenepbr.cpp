...
ScenePbr::ScenePbr() : plane(20, 20, 1, 1), teapot(5, glm::mat4(1.0f)), sphere(1.0f, 36, 18),
...
void ScenePbr::drawScene() {
	...
	// Copper
	drawSpot(glm::vec3(-0.0f, 0.0f, 3.0f), metalRough, 1, glm::vec3(0.95f, 0.64f, 0.54f));
	//// Aluminum
	...
	// Silver
	drawSpot(glm::vec3(3.0f, 0.0f, 3.0f), metalRough, 1, glm::vec3(0.91f, 0.92f, 0.92f));
